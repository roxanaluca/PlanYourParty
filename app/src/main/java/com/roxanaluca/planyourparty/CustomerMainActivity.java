    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_custom_package.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CustomerMainActivity.this, CustomPackageActivity.class);
        ...
        button_standard_package.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CustomerMainActivity.this, StandardPackageActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
